...
ActiveRecord::Schema.define(version: 20170421133523) do
  ...
  add_index "calendar_of_the_championships", ["number", "country"], name: "index_calendar_of_the_championships_on_number_and_country", unique: true, using: :btree
